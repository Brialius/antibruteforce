...
func init() {
	...
	RootCmd.Flags().Uint64P("login-limit", "l", 10, "login rate limit per minute")
	RootCmd.Flags().Uint64P("password-limit", "w", 100, "password rate limit per minute")
	RootCmd.Flags().Uint64P("ip-limit", "i", 1000, "ip rate limit per minute")
